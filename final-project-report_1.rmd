...
From the table above, compare all criterions, we choose m1_suicide_aic, m2_suicide_aic and model2 to do further investigate.

```{r}
AIC_and_predictors = data.frame(
  "AIC" = c("m2_suicide" = extractAIC(m2_suicide_aic)[2],
            "m1_suicide" = extractAIC(m1_suicide_aic)[2],
            "model2" = extractAIC(selected2)[2]),
  "Predictors" = c("m2_suicide" = extractAIC(m2_suicide_aic)[1],
                   "m1_suicide" = extractAIC(m1_suicide_aic)[1],
                   "model2" = extractAIC(selected2)[1])
                              )
...
```{r}
anova(m2_suicide_aic, selected2)
```
